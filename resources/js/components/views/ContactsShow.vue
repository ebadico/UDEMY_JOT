<template>
    <div >
        <div v-if="accessDenied">
            <h2 class="text-center text-3xl py-10">Access Denied</h2>
            <a href="#" @click="$router.back()" class="text-center text-blue-400 block border hover:border-blue-400">Go back</a>
        </div>
        <div v-else-if="dataIsLoaded && !accessDenied">
